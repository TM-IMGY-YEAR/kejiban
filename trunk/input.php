			...
			<div>
				<table class="inputArticle">
					...
					<tr>
						...
						<td><div>
							<?php
							$stmtOfRadioButton = $db->getDbconnect()->prepare("select COLOR_ID, COLOR_CODE, COLOR_NAME from COLOR_MASTER;");
							$stmtOfRadioButton->execute();

								while ($row = $stmtOfRadioButton->fetch()) {
